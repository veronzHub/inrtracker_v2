  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to INR Tracker, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to INRTracker.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to INRTracker, accessible from{" "}
            <a
              href="https://inrtracker.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://inrtracker.com
            </a>
          </p>
        </li>
        <li>
